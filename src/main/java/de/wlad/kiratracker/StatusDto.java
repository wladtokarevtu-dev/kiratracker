...
public class StatusDto {
    ...
    private List<FoodEntryDto> foodToday;
    private Map<String, Long> leaderboard;
    private WeatherDto weather;
    private long pendingRequests;
    public StatusDto(boolean m, boolean e, List<WalkEntryDto> en, Map<String, Long> lb, WeatherDto w, long req, List<FoodEntryDto> fd) {
        this.wasMorning = m; this.wasEvening = e; this.entries = en; this.leaderboard = lb; this.weather = w; this.pendingRequests = req; this.foodToday = fd;
    }
    ...
    public List<FoodEntryDto> getFoodToday(){return foodToday;}
}